...
('MSAC', 'Albert Park', 'VIC',
 ...
 'Friendly drop-in social event where players of all levels are welcome. Organisers match participants by skill level for balanced games. Price includes shuttlecocks and court costs.',
 'Saturday', '5:30 PM – 7:30 PM', 'weekly', '$13/session', 'All levels',
 'https://www.msac.com.au/',
 'https://www.msac.com.au/'),
...
('MSAC', 'Albert Park', 'VIC',
 ...
 'Relaxed social badminton at MSAC Courts 5–8. Friendly doubles with rotating courts. Minimum group of 4. Quality shuttles provided. Free parking.',
...
('Beyond Badminton Centre', 'Clayton', 'VIC',
 'Thursday BBC Social',
 'Doubles-only court rotation social at Beyond Badminton Centre (18 courts). Courts 5–11 used. Shuttles provided, bring your own racquet. Non-marking shoes required. Free onsite parking. Book online via YEP!Booking.',
...
('Victor Badminton Centre', 'Botany', 'NSW',
 ...
 'Intermediate-level social session — 2 courts booked, max 16 players. Games to 30 points, 1 shuttle per game.',
...
('Victor Badminton Centre', 'Botany', 'NSW',
 'Wednesday Social Badminton',
 'Intermediate-level evening social — 2 courts, max 16 players. Games to 30 points.',
